...
const config = {
  title: 'Grafana Scenes ML',
  tagline: 'Add Machine Learning functionality to your Scenes.',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/grafana/scenes-ml/edit/main/docusaurus/website',
        },
        theme: {
